...
urlpatterns = [
    ...
    path('owner/cameras/', views.camera_center, name='camera_center'),
    path('owner/cameras/setup/', views.camera_setup, name='camera_setup'),
    path('owner/cameras/guide/', views.camera_gateway_guide, name='camera_gateway_guide'),
    path('owner/cameras/<int:camera_id>/', views.camera_detail, name='camera_detail'),
    ...
    path('paiement/stripe/webhook/', views.stripe_webhook, name='stripe_webhook'),
    ...
    path('mentions-legales/', views.legal_notice, name='mentions'),
    path('politique-confidentialite/', views.privacy_policy, name='privacy_policy'),
    path('suppression-compte/', views.account_deletion, name='account_deletion'),
    path('legal-notice/', views.legacy_legal_redirect, name='legal_notice'),
    path('cgv/', views.terms, name='cgv'),
